package com.example.lockpartem.compoment.patternlockview
...
import com.example.lockpartem.compoment.dotview.DotView
import com.example.lockpartem.compoment.dotview.model.Dot
...
class PatternLockView @JvmOverloads constructor(
    ...
    public var stagePasswords = linkedMapOf<PatternViewStageState, String>()
                            ...
                            PatternViewStageState.SECOND -> {
                                ...
                                state =
                                    if (stagePasswords[PatternViewStageState.FIRST] != stagePasswords[PatternViewStageState.SECOND]) {
                                        Log.d("TAG", "Error: ${stagePasswords[PatternViewStageState.SECOND].toString()}")
